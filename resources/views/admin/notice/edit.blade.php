                    ...
                    <div class="row gx-4">
                        <div class="col-lg-8">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <input class="form-control" id="postTitleInput" type="text" name="notice_title"
                            ...
                            <div class="card card-header-actions mb-4 mb-lg-0">
                                ...
                                <div class="card-body">
                                    <textarea id="editor" name="notice_content">{!! $notice->notice_content !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="card card-header-actions">
                                ...
                                <div class="card-body">
                                    <div class="d-grid mb-3">
                                        <button class="fw-500 btn btn-primary" onclick="updateNotice({{ $notice->notice_id }})">수정</button>
                                    </div>
                                    <div class="d-grid">
